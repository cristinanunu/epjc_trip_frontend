...
const About = () => {
  return (
    <Box color={'gray.700'} pt={20}>
      <Heading fontSize="4xl" m={{ base: '2rem 1rem', lg: '2rem 5rem', xl: '2rem 12rem' }} textAlign={'center'}>
        About us
      </Heading>
      <Developers />
      <Divider orientation="horizontal" borderWidth={'1px'} m={'1rem auto'} w="50%" />
      <Grid templateColumns={'repeat(4,1fr)'} p="4px" gridGap={2} m={{ base: '1rem', lg: '1rem 5rem', xl: '1rem 12rem 1rem 12rem' }}>
        <GridItem colSpan={{ base: 4, md: 1 }}>
          <Box borderColor="black" height={{ base: '5vh', md: 'fit-content' }}>
            <Heading fontSize={{ base: '2xl', md: '3xl' }} backgroundColor={'transparent'}>
              Who we are
            </Heading>
          </Box>
        </GridItem>
